...
function generatePlan(d) {
  ...
  // Ideal body weight. Devine when sex is recorded; otherwise a sex-neutral estimate from
  // mid-normal BMI (22.5 kg/m2), so an unanswered Sex field does not silently revert the
  // target to actual body weight.
